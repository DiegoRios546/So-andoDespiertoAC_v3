...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="contacto.php"><i class="fa fa-edit"></i> Mensajes</a>
                    </li>
                    <li>
...
<td class="iconos">
                           <a href="visualizar.php?id=<?php echo $fila['id'] ?>&ver=contacto" data-toggle="modal" data-target="#myModal"><button type="button" class="btn-circle btn btn-primary"><img src="../img/vista.png" class="icono" alt="ver"></button></a>
