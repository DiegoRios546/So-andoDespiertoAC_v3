            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Body    = 'Link de verificación de nueva cuenta en "Soñando Desperto": <b><a href="http://localhost/login/?verification='.$code.'">http://localhost/login/?verification='.$code.'</a></b>';
                    ...
                    echo "</div>";
                    $msg = "<div class='alert alert-info'>Enviamos un link de verificación a tu correo, por favor verifica.</div>";
                } else {
                    $msg = "<div class='alert alert-danger'>Algo salió mal, intenta de nuevo</div>";
                }
            } else {
                $msg = "<div class='alert alert-danger'>La contraseña y la confirmación de contraseña no coinciden.</div>";
            }
        }
    }
?>
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="email" class="email" name="email" placeholder="Correo Electrónico" value="<?php if (isset($_POST['submit'])) { echo $email; } ?>" required>
